...
The generated report and landing page also include an official API-rate and subscription-credit sensitivity table for GPT-6 Astra, GPT-6 Sol, GPT-6 Luna, GPT-5.6 Sol, and GPT-5.3 Codex. It applies published standard short-context API input rates and standard-speed plan input-credit rates to the same fixture, with output, cache-hit, tool-call, and actual allowance/message conversion excluded. Rates are manually verified against [OpenAI's API pricing page](https://developers.openai.com/api/docs/pricing) and [ChatGPT pricing guidance](https://learn.chatgpt.com/docs/pricing); re-check them before invoicing or publishing a new claim.
