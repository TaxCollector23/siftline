...
function SiteHeader() { return <header className="wrap site-header"><a className="brand" href="/">siftline<span>_</span></a><nav><a href="/#connect">connect</a><a href="/benchmarks">benchmark</a><a href="https://github.com/TaxCollector23/siftline">github ↗</a></nav></header> }
function SiteFooter() { return <footer className="wrap footer"><span>© 2026 Siftline</span><span>source-side request optimization</span><span>MIT</span></footer> }
