...
export interface OptimizationResult { originalRequest: OptimizeInput["request"]; optimizedRequest: OptimizeInput["request"]; applied: PassResult[]; skipped: PassResult[]; estimatedSavings: { bytes: number; inputTokens: number; percent: number }; confidence: "high" | "medium" | "low"; safety: "safe" | "passed-through"; explanation: string[] }
